...
2026/5/11: 根据学校模板要求，四周页边距改为2cm。

2024/12/30: 修改了目录节的页眉和页码格式，以及给封面页留出空白，保证其位于奇数页。
...
同时也可以参考[清华大学论文Word模板](https://github.com/fatalerror-i/ThuWordThesis)，获取更多关于Word排版的细节知识。
